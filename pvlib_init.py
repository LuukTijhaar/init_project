...
#@st.cache_data
def get_parameters(_type_paneel:str,_breedtegraad=52.2215, _lengtegraad=6.8937, _tijdzone='Europe/Amsterdam', _hoogte=42, _type_omvormer="ABB__PVI_3_0_OUTD_S_US__208V_", _montage_type='open_rack_glass_polymer'):
    ...
    st.write(f"Type paneel gekozen: {_type_paneel}")
...
def Initialize_Systeem1(_location, _module, _inverter, _temperature_parameters, _hellingshoek=45, _azimuth=180, _panelen_per_reeks=1, _reeksen_per_omvormer=1,_start_date='2021-01-01', _end_date='2021-12-31'):
